...
const TestimonialCard = ({ testimonial }) => (
  <div className='w-full bg-white dark:bg-gray-900 border border-gray-200 text-center sm:text-left items-center sm:items-start dark:border-gray-700 rounded-2xl p-6 flex flex-col gap-4 shadow-sm hover:shadow-md hover:border-primary dark:hover:border-primary transition-all duration-300 text-center sm:text-left items-center sm:items-start'>
